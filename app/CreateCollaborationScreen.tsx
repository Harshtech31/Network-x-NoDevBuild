      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.mediaSection}>
          <TouchableOpacity style={styles.mediaButton} onPress={() => setShowImagePicker(true)}>
            <Ionicons name="image-outline" size={24} color="#DC2626" />
...
const styles = StyleSheet.create({
  ...
  typeChip: { backgroundColor: '#fef2f2', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, marginRight: 12, borderWidth: 1, borderColor: '#DC2626' },
  typeChipSelected: { backgroundColor: '#DC2626' },
  typeText: { color: '#DC2626', fontWeight: '500' },
  ...
  skillChipSelected: { backgroundColor: '#DC2626', borderColor: '#DC2626' },
  ...
  durationChip: { backgroundColor: '#FEF3C7', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, marginRight: 8, borderWidth: 1, borderColor: '#F59E0B' },
  durationChipSelected: { backgroundColor: '#F59E0B' },
  durationText: { color: '#F59E0B', fontWeight: '500', fontSize: 12 },
  durationTextSelected: { color: '#FFFFFF' },
  commitmentContainer: { flexDirection: 'row', paddingRight: 20 },
  commitmentChip: { backgroundColor: '#ECFDF5', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, marginRight: 12, borderWidth: 1, borderColor: '#10B981' },
  commitmentChipSelected: { backgroundColor: '#10B981' },
  commitmentText: { color: '#10B981', fontWeight: '500' },
  commitmentTextSelected: { color: '#FFFFFF' },
  mediaSection: { marginBottom: 30 },
  mediaButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', padding: 16, borderRadius: 12, borderWidth: 2, borderColor: '#DC2626', borderStyle: 'dashed' },
  mediaButtonText: { marginLeft: 8, fontSize: 16, color: '#DC2626', fontWeight: '500' },
  ...
  modalCancelText: { fontSize: 16, color: '#DC2626', fontWeight: '500' },
